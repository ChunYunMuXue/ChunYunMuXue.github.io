...
<p align="center">
  <img src="icons/svg2ico.svg" alt="SVG to ICO file" width="115" height="115"> 
    </p>
    <h2 align="center">
    SVG2ICO</h2>
<p align="center">
The simplest command-line tool to convert SVG files & folders to ICO (Windows icon / Favicon) format.
...
📄 License: <a href="https://github.com/visyoss/svg2ico/blob/bd6c01f8e35ffbed2f17155b014302201caee884/LICENSE">MIT</a> | 
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset=https://github.com/user-attachments/assets/250dfba2-3fbb-4abd-9ccc-8c69c0d46883">
    <source media="(prefers-color-scheme: light)" srcset="https://github.com/user-attachments/assets/b716551c-e841-4971-9973-2267fe058402">
    <img alt="Contact us" src="https://github.com/user-attachments/assets/250dfba2-3fbb-4abd-9ccc-8c69c0d46883">
    </picture>
<a href="mailto:dev@webflok.com">Email</a>
</h4>
