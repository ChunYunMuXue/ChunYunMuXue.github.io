                                ...
                                {item.tags.map(tag => (
                                    <span
                                        ...
                                        className={cn(
                                            ...
                                            tag.toLowerCase().includes('national') || tag.toLowerCase().includes('international')
                                                ? "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400"
                                                : tag.toLowerCase().includes('gold') || tag.toLowerCase().includes('champion') || tag.toLowerCase().includes('oral')
                                                ? "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400"
                                                : tag.toLowerCase().includes('grandmaster') || tag.toLowerCase().includes('finalist')
